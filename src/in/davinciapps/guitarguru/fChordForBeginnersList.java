...
public class fChordForBeginnersList extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fchordforbeginnerslist);
	}
	...
	public void loadFBarreChordDetailPage(View view) {
		// Create Intent
		TextView textView;
		textView = (TextView) findViewById(R.id.fBarreChord_Button1);
