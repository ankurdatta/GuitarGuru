...
public class CommonOpenSlashChordsList extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_commonopenslashchordslist);
	}
	...
	public void loadDSlashFChordDetailPage(View view){
		// Create Intent
		TextView textView;
		textView = (TextView)findViewById(R.id.commonopenslash_Button1);
	...
	public void loadGSlashBChordDetailPage(View view){
		// Create Intent
		TextView textView;
		textView = (TextView)findViewById(R.id.commonopenslash_Button2);
		chordNameSelected = textView.getText().toString();
		Intent intent=new Intent(this, ChordDetailPage.class);
		intent.putExtra(EXTRA_CHORD_NAME_SELECTED, chordNameSelected);
		startActivity(intent);
	...
	public void loadCSlashGChordDetailPage(View view){
		// Create Intent
		TextView textView;
		textView = (TextView)findViewById(R.id.commonopenslash_Button3);
		chordNameSelected = textView.getText().toString();
		Intent intent=new Intent(this, ChordDetailPage.class);
		intent.putExtra(EXTRA_CHORD_NAME_SELECTED, chordNameSelected);
		startActivity(intent);
